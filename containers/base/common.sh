...
CONFIGDB_EQL_PORT=${CONFIGDB_EQL_PORT:-2379}
...
CONFIGDB_EQL_SERVERS=${CONFIGDB_EQL_SERVERS:-"127.0.0.1:$CONFIGDB_EQL_PORT"}
...
etcd_ssl_ca_cert=${ETCD_SSL_CA_CERT:-${SERVER_CA_CERTFILE}}
etcd_ssl_keyfile=${ETCD_SSL_KEYFILE:-${SERVER_KEYFILE}}
etcd_ssl_certfile=${ETCD_SSL_CERTFILE:-${SERVER_CERTFILE}}
